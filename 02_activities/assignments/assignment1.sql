...
FROM vendor AS v;
INNER JOIN vendor_booth_assignments AS vc
	ON vc.vendor_id = v.vendor_id
ORDER BY v.vendor_name, vc.market_date
...
SELECT  vendor_id,
count(vendor_id) AS num_of_rented_booths
...
-- join customer_purchases and customer
